    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_price', models.FloatField(default=100.0, help_text='this is the price if no discount, if is discount it become an old price')),
                ('slug', models.SlugField(default=None)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('inventory', models.IntegerField(default=5)),
                ('top_deal', models.BooleanField(default=False)),
                ('flash_sales', models.BooleanField(default=False)),
                ('discountValue', models.DecimalField(decimal_places=2, default=0.0, help_text='put discount value', max_digits=5)),
